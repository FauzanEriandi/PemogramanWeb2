            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                  <a href="{{ url('periksa/detail/'.$periksa->id)}}"><button class="btn btn-success">Detail</button></a>
                    <a href="{{ url('periksa/edit/'.$periksa->id)}}"><button class="btn btn-warning">Edit</button></a> 
                    <a href="{{ url('periksa/delete/'.$periksa->id)}}"><button class="btn btn-danger">Hapus</button></a></td>
                </tr>
                @endforeach
              </tbody>
            </table>
          ...
          <div class="modal-dialog" role="document">
              <div class="modal-content">
                  <div class="modal-header">
                      <h5 class="modal-title" id="inputModalLabel">Tambah Daftar Periksa</h5>
