            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                  <a href="{{ url('unit_kerja/edit/'.$unit_kerja->id)}}"><button class="btn btn-warning">Edit</button></a> 
                  <a href="{{ url('unit_kerja/delete/'.$unit_kerja->id)}}"><button class="btn btn-danger">Hapus</button></a></td>
                </tr>
                @endforeach
              </tbody>
            </table>
