            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $pasien->email }}</td>
                  <td>
                    <a href="{{ url('pasien/detail/'. $pasien->id) }}"><button class="btn btn-success">Detail</button></a>
                    <a href="{{ url('pasien/edit/'. $pasien->id) }}"><button class="btn btn-warning">Edit</button></a> 
                    <a href="{{ url('pasien/delete/'. $pasien->id) }}">
                      <button class="btn btn-danger"
                      onclick="return confirm('hapus nama pasien yang bernama {{ $pasien->nama }}')">Hapus</button></a></td>
