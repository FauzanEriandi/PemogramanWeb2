      ...
      <div class="card">
        ...
        <div class="card-body">
          @foreach ($data_paramedik as $paramedik)
                      <form action="{{url('paramedik/update/'. $paramedik->id)}}" method="POST">
                          {{csrf_field()}}
                        <div class="form-group">
                          <label for="nama">Nama</label>
                          <input type="text" class="form-control" value="{{ $paramedik->nama }}" id="nama" name="nama" required>
                      </div>
                      <div class="form-group">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{$paramedik->tmp_lahir}}" id="tmp_lahir" name="tmp_lahir" required>
                    </div>
                    <div class="form-group">
                      <label for="tgl_lahir">Tanggal Lahir</label>
                      <input type="date" class="form-control" value="{{$paramedik->tgl_lahir}}" id="tgl_lahir" name="tgl_lahir" required>
                  </div>
                  <div class="form-group">
                    <label for="telepon">Telepon</label>
                    <input type="text" class="form-control" value="{{$paramedik->telepon}}" id="telepon" name="telepon" required>
                </div>
                <div class="form-group">
                  <label for="alamat">Alamat</label>
                  <input type="text" class="form-control" value="{{$paramedik->alamat}}" id="alamat" name="alamat" required>
              </div>
                          <div class="form-group">
