            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ url('paramedik/detail/'. $paramedik->id) }}"><button class="btn btn-success">Detail</button></a>
                    <a href="{{ url('paramedik/edit/'. $paramedik ->id) }}"><button class="btn btn-warning">Edit</button></a> 
                    <a href="{{ url('paramedik/delete/'.$paramedik->id)}}">
                      <button class="btn btn-danger"
                      onclick="return confirm('Hapus nama dokter bernama {{ $paramedik->nama }}')">Hapus</button></a></td>
                </tr>
                @endforeach
              </tbody>
            </table>
        ...
        <div class="modal fade" id="inputModal" tabindex="-1" role="dialog" aria-labelledby="inputModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
              <div class="modal-content">
                  ...
                  <div class="card-body">
                      <form action="{{url('paramedik/store')}}" method="POST">
                          {{csrf_field()}}
