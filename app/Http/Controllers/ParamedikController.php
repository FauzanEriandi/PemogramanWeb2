...
class ParamedikController extends Controller
{
    ...
    public function show(string $id)
    {
        ...
        ->select('paramedik.*','paramedik.nama as nama_unit_kerja')
        ->get();
        $unit_kerja = Unit_kerja::all();
        $data_paramedik = $data->where('id',$id);
        return view('paramedik.detail', compact('data_paramedik','unit_kerja'));
    }
    ...
    public function edit(string $id)
    {
        ...
        ->get();
        $unit_kerjas = unit_kerja::all();
        return view('paramedik.edit', compact('data_paramedik','unit_kerjas'));
    }
    ...
    {
        $paramedik = Pasien::find($request->id);
        $paramedik->nama = $request->nama;
        $paramedik->gender = $request->gender;
        $paramedik->tmp_lahir = $request->tmp_lahir;
        $paramedik->tgl_lahir = $request->tgl_lahir;
    ...
    {
        DB::table('paramedik')->where('id',$id)->delete();
        return redirect('paramedik');
    }
}
